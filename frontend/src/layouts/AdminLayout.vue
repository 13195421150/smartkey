  ...
  <div class="app-shell" :class="[`layout-${layout}`, `nav-${nav}`]">
    ...
    <aside v-if="layout === 'sidebar' || layout === 'rail'" class="sidenav">
      <div class="side-brand" @click="router.push('/ops')">
        <img class="portal-admin-logo" src="/black-cat.png" alt="黑猫标志" width="36" height="36" />
...
<style scoped>
.portal-admin-logo { width:36px; height:36px; object-fit:contain; border-radius:8px; background:#fff; }
.app-shell {
  min-height: 100vh;
  display: flex;
